...
public class SuggestActivity  extends BaseNavDrawerActivity{
	SuggestActivity mContext;
	SuggestFragment mFragment;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		getSupportActionBar().setTitle(R.string.queries);
		mFragment = new SuggestFragment();
