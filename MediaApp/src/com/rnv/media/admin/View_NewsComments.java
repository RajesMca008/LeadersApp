...
public class View_NewsComments extends BaseNavDrawerActivity{
	View_NewsComments mContext;
	View_NewsCommentsFragment mFragment;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mFragment = new View_NewsCommentsFragment();
