...
public class PostNewsActivity extends BaseNavDrawerActivity{
	PostNewsActivity mContext;
	PostNewsFragment mFragment;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		getSupportActionBar().setTitle(R.string.post_news);
		mFragment = new PostNewsFragment();
