...
public class ViewQueriesActivity extends BaseNavDrawerActivity{
	ViewQueriesActivity mContext;
	ViewQueriesFragment mFragment;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mFragment = new ViewQueriesFragment();
